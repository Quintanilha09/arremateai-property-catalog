...
class GlobalExceptionHandlerTest {
    ...
    private static final String URI_TESTE = "/api/imoveis/123";
    ...
    void handleBusinessDeveRetornar400ComTipoBusiness() {
        ProblemDetail problema = handler.handleBusiness(
                new BusinessException("Imóvel já cadastrado"), requisicao);
        ...
        assertThat(problema.getDetail()).isEqualTo("Imóvel já cadastrado");
    ...
    void handleEntityNotFoundDeveRetornar404ComTipoNotFound() {
        ProblemDetail problema = handler.handleEntityNotFound(
                new EntityNotFoundException("Imóvel 123 não existe"), requisicao);
        ...
        assertThat(problema.getDetail()).isEqualTo("Imóvel 123 não existe");
    }
    ...
    void handleValidationDeveRetornar400ComErrosDeCampo() {
        ...
        FieldError campoTitulo = new FieldError("objeto", "titulo", "não pode ser vazio");
        FieldError campoValor = new FieldError("objeto", "valorMinimo", "obrigatório");
        when(bindingResult.getFieldErrors()).thenReturn(List.of(campoTitulo, campoValor));
        ...
        assertThat(erros.get(0)).containsEntry("field", "titulo").containsEntry("message", "não pode ser vazio");
        assertThat(erros.get(1)).containsEntry("field", "valorMinimo").containsEntry("message", "obrigatório");
    }
    ...
    void handleConstraintViolationDeveRetornar400ComErros() {
        ...
        when(caminho.toString()).thenReturn("metodo.arg0.titulo");
        ...
        List<Map<String, String>> erros = (List<Map<String, String>>) problema.getProperties().get("errors");
        assertThat(erros).hasSize(1);
        assertThat(erros.get(0)).containsEntry("field", "metodo.arg0.titulo")
